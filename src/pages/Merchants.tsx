      ...
      <section className="py-16 md:py-24 px-4" aria-labelledby="merchant-heading">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-base text-muted-foreground max-w-xl mx-auto">
            Learn more about our <Link to="/products" className="text-primary hover:underline">products and services</Link> or read <Link to="/about" className="text-primary hover:underline">about our company</Link>.
          </p>
        </div>
      </section>
