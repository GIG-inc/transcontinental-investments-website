  ...
  const breadcrumbSchema = {
    ...
    "itemListElement": [
      ...
      },
      {
        ...
        "item": "https://transcontinentalinvestments.com/products/refinery"
      }
    ]
  };
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <main className="flex-1">
        {/* Hero */}
        <section className="py-16 md:py-24 px-4" aria-labelledby="refinery-heading">
          <div className="container mx-auto max-w-4xl">
            <div className="inline-block mb-4 px-4 py-2 bg-primary/10 rounded-full">
              <span className="text-sm font-medium text-foreground">Development Late 2026 • Operations Early 2027</span>
            </div>
            <h1 id="refinery-heading" className="font-display text-4xl md:text-5xl lg:text-6xl font-light tracking-wide text-foreground mb-6">
              Refinery Facility
            </h1>
        ...
        {/* Vision */}
        <section className="py-12 px-4 bg-secondary/20" aria-labelledby="refinery-vision">
          <div className="container mx-auto max-w-4xl">
            <h2 id="refinery-vision" className="font-display text-3xl md:text-4xl font-light tracking-wide text-foreground mb-8 text-center">
              Our Vision
            </h2>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="flex flex-col items-center text-center p-6">
                <div className="p-4 rounded-lg bg-secondary mb-4">
                  <Factory className="h-8 w-8 text-foreground" aria-hidden="true" />
                </div>
              ...
              <div className="flex flex-col items-center text-center p-6">
                <div className="p-4 rounded-lg bg-secondary mb-4">
                  <Zap className="h-8 w-8 text-foreground" aria-hidden="true" />
                </div>
              ...
              <div className="flex flex-col items-center text-center p-6">
                <div className="p-4 rounded-lg bg-secondary mb-4">
                  <Leaf className="h-8 w-8 text-foreground" aria-hidden="true" />
                </div>
        ...
        {/* Timeline */}
        <section className="py-16 px-4" aria-labelledby="refinery-timeline">
          <div className="container mx-auto max-w-4xl">
            <h2 id="refinery-timeline" className="font-display text-3xl md:text-4xl font-light tracking-wide text-foreground mb-8">
        ...
        {/* Benefits */}
        <section className="py-12 px-4 bg-secondary/20" aria-labelledby="refinery-benefits">
          <div className="container mx-auto max-w-4xl">
            <h2 id="refinery-benefits" className="font-display text-3xl md:text-4xl font-light tracking-wide text-foreground mb-6 text-center">
              Strategic Benefits
            </h2>
        ...
        {/* CTA */}
        <section className="py-16 px-4 bg-primary text-primary-foreground" aria-labelledby="refinery-cta">
          <div className="container mx-auto max-w-2xl text-center">
            <h2 id="refinery-cta" className="font-display text-3xl md:text-4xl font-light tracking-wide mb-6">
              Stay Updated
            </h2>
