  ...
  const breadcrumbSchema = {
    ...
    "itemListElement": [
      ...
      },
      {
        ...
        "item": "https://transcontinentalinvestments.com/products/gold-selling"
      }
    ]
  };
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <main className="flex-1">
        {/* Hero */}
        <section className="py-16 md:py-24 px-4" aria-labelledby="gold-selling-heading">
          <div className="container mx-auto max-w-4xl">
            <h1 id="gold-selling-heading" className="font-display text-4xl md:text-5xl lg:text-6xl font-light tracking-wide text-foreground mb-6">
        ...
        {/* Who We Sell To */}
        <section className="py-12 px-4 bg-secondary/20" aria-labelledby="who-we-sell">
          <div className="container mx-auto max-w-4xl">
            <h2 id="who-we-sell" className="font-display text-3xl md:text-4xl font-light tracking-wide text-foreground mb-8">
              Who We Sell To
            </h2>
        ...
        {/* Why Choose Us */}
        <section className="py-16 px-4" aria-labelledby="why-choose-us">
          <div className="container mx-auto max-w-4xl">
            <h2 id="why-choose-us" className="font-display text-3xl md:text-4xl font-light tracking-wide text-foreground mb-8">
              Why Choose Us
            </h2>
        ...
        {/* International Buyers */}
        <section className="py-12 px-4 bg-secondary/20" aria-labelledby="international-buyers">
          <div className="container mx-auto max-w-4xl text-center">
            <h2 id="international-buyers" className="font-display text-3xl md:text-4xl font-light tracking-wide text-foreground mb-6">
              Open to International Companies
            </h2>
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              We welcome partnerships with international companies looking to source premium precious metals from East Africa. Our extensive network and logistics capabilities ensure reliable supply chains. <Link to="/contact" className="text-primary hover:underline">Contact us</Link> to discuss partnership opportunities.
            </p>
          </div>
        </section>

        {/* CTA */}
        <section className="py-16 px-4 bg-primary text-primary-foreground" aria-labelledby="gold-selling-cta">
          <div className="container mx-auto max-w-2xl text-center">
            <h2 id="gold-selling-cta" className="font-display text-3xl md:text-4xl font-light tracking-wide mb-6">
